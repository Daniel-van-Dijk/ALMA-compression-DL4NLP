...
for tgt in "${!languages[@]}"; do
    ...
    src_path="data/from_english/${languages[$tgt]}/src.txt"
    hyp_path="output/from_english/${languages[$tgt]}/$model.txt"
    tgt_path="data/from_english/${languages[$tgt]}/tgt.txt"
...
for src in "${!languages[@]}"; do
    ...
    src_path="data/to_english/${languages[$src]}/src.txt"
    hyp_path="output/to_english/${languages[$src]}/$model.txt"
    tgt_path="data/to_english/${languages[$src]}/tgt.txt"
